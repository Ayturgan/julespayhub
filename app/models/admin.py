...
class AdminQRCode(Base):
    """Модель для QR-кодов, созданных администраторами"""
    __tablename__ = "admin_qr_codes"
    ...
    # Связи
    admin = relationship("Admin", backref="qr_codes")
    
    __table_args__ = (
        {'comment': 'QR-коды, созданные администраторами'}
    )
